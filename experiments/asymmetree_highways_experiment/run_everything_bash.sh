...
NLEAVES=$4
#echo "simulation"
#python3 asymmetree_simulation.py $NRUNS $NGENETREES $NHWAYS $NLEAVES 
...
for ((i=0; i<NRUNS;i++)); do python3 build_true_network.py simulation_output/simulated_species_trees/species_tree${NLEAVES}leaves_${i}.gr simulation_output/simulated_species_trees/highway_${NLEAVES}_${i}.hway > simulation_output/true_networks/true_network_${NLEAVES}leaves_${i}.gr; done
